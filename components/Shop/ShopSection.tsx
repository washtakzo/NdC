...
const ShopSection = () => {
  return (
    <section className="flex flex-col px-4 bg-primary md:flex-row md:justify-around md:py-8">
      <div className="my-4">
        <ul className=" md:sticky md:top-[40vh]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:w-[70%]">
